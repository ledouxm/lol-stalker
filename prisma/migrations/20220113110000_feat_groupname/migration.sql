...
INSERT INTO "new_Friend" ("createdAt", "gameName", "gameTag", "groupId", "icon", "id", "name", "puuid", "summonerId") SELECT "createdAt", "gameName", "gameTag", "groupId", "icon", "id", "name", "puuid", "summonerId" FROM "Friend";
DROP TABLE "Friend";
